...
export function AddCameraModalContent(props: AddCameraModalContentProps) {
  ...
  return (
    ...
    >
      <Stack>
        <TextInput name="Nama Kamera" value={name} onChange={(e) => setName(e.target.value)} placeholder="Tambahkan nama kamera" />
        <TextInput name="URL Kamera" value={url} onChange={(e)=> setUrl(e.target.value)} placeholder="RTSP URL" />
